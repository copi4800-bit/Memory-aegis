...
Feature work should follow the Spec Kit flow in this project:
...
6. Implement with tests, benchmarks, and explanation output in mind.
...
- When roadmap material, specs, and current code disagree, the active spec and this constitution govern the next change set.
